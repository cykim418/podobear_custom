...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        bi = np.floor(np.arange(n) / batch_size).astype(int)  # batch index #nh: fix np.int to int
        ...
        if self.rect:
            ...
            self.batch_shapes = np.ceil(np.array(shapes) * img_size / stride + pad).astype(int) * stride #nh: fix np.int to int
