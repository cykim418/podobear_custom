...
My Usage:
    ...
    please use pytorch version up to 1.10.0
    https://github.com/facebookresearch/playtorch/issues/164#issuecomment-1329959043
'''
...
def export_torchscript(model, im, file, optimize, prefix=colorstr('TorchScript:')):
    ...
    try:
        ...
        if optimize:  # https://pytorch.org/tutorials/recipes/mobile_interpreter.html
            ...
            f = file.with_suffix('.torchscript.ptl') # HACK: nanhee
